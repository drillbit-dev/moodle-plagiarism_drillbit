...
class plagiarism_drillbit_observer {
    ...
    public static function course_module_deleted(
        ...
        $DB->delete_records('plagiarism_drillbit_files', array('cm' => $eventdata['contextinstanceid']));
        $DB->delete_records('drillbit_plugin_config', array('cm' => $eventdata['contextinstanceid']));
    }
