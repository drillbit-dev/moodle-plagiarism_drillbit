...
class plagiarism_drillbit_setup_form extends moodleform {
    public function definition() {
        ...
        $mform->addElement('header', 'plagiarism_drillbit', get_string('drillbitaccountconfig', 'plagiarism_drillbit'));
        $mform->setExpanded('plagiarism_drillbit');

        $mform->addElement('text', 'plagiarism_drillbit_emailid', get_string('drillbitemailid', 'plagiarism_drillbit'));
        $mform->setType('plagiarism_drillbit_emailid', PARAM_TEXT);

        $mform->addElement('passwordunmask', 'plagiarism_drillbit_password', get_string('drillbitpassword', 'plagiarism_drillbit'));

        $mform->addElement('text', 'plagiarism_drillbit_folderid', get_string('drillbitfolderid', 'plagiarism_drillbit'));
        $mform->setType('plagiarism_drillbit_folderid', PARAM_TEXT);

        $mform->addElement('text', 'plagiarism_drillbit_apikey', get_string('drillbitapikey', 'plagiarism_drillbit'));
